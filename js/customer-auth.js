...
async function showCustomerDashboard() {
  ...
  loadingModal.style.cssText = 'position:fixed;top:0;left:0;right:0;bottom:70px;background:#f5f5f5;z-index:9500;display:flex;align-items:center;justify-content:center;';
...
function openMyOrdersPage() {
  ...
  ordersModal.style.cssText = 'position:fixed;top:0;left:0;right:0;bottom:70px;background:#f5f5f5;z-index:9550;display:flex;flex-direction:column;';
